...
def densenet121_model(nb_dense_block=4, growth_rate=32, nb_filter=64, reduction=0.5, dropout_rate=0.0, weight_decay=1e-4, num_classes=None):
    '''
    ...
    if K.image_dim_ordering() == 'tf':
      concat_axis = 3
      img_input = Input(shape=(299, 299, 3), name='data')
    else:
      concat_axis = 1
      img_input = Input(shape=(3, 299, 299), name='data')
